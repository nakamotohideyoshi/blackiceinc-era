...
@Component
public class CfgMktIrrSpcRiskObjectMapper extends AbstractObjectMapper<CfgObject> {
    ...
    CfgMktIrrSpcRisk createRow(Row row) {
        ...
        cfgMktIrrSpcRisk.setSeq(getLongValue(row.getCell(7)));
    ...
    public void importData(XSSFSheet sheet) {
        ...
        for (CfgMktIrrSpcRisk cfgMktIrrSpcRisk : all) {
            ...
            createCell(row, 7, cfgMktIrrSpcRisk.getSeq());
