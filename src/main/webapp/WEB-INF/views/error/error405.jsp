...
<head>
    ...
    <link rel="apple-touch-icon" href="resources/mg/splash/sptouch-icon-iphone.png">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="text-center error-box">
                            <h1 class="error-text tada animated"><i class="fa fa-times-circle text-danger error-icon-shadow"></i> Error 405</h1>
                            <h2 class="font-xl"><strong>Oooops, Some internal service went wrong!</strong></h2>
                            <br />
